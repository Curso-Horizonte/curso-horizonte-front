                    ...
                    <tr key={doc.id}>
                      ...
                      <td className="actions-cell">
                        <button
                          ...
                          onClick={() => openModal("editDocument", { document: doc })}
                        >
                      ...
                      <tr key={student.id}>
                        ...
                        <td>
                          <span
                            ...
                            onClick={() => openModal("editGrade", {
                              student: { name: student.name, grade: student.bim1, bimestre: "1º Bimestre" }
                            })}
                          >
                            {student.bim1}
                        ...
                        <td>
                          <span
                            className="grade-cell grade-cell-clickable"
                            onClick={() => openModal("editGrade", {
                              student: { name: student.name, grade: student.bim2, bimestre: "2º Bimestre" }
                            })}
                          >
                            {student.bim2}
                            <img src={EditIcon} alt="editar" width={12} height={12} className="grade-edit-icon" />
                        ...
                        <td>
                          <span
                            ...
                            onClick={() => openModal("launchGrade", {
                              student: { name: student.name, nextBim: "3º Bimestre" }
                            })}
                          >
                            -
                          </span>
                        ...
                        <td>
                          <span
                            className="grade-cell grade-cell-clickable grade-empty"
                            onClick={() => openModal("launchGrade", {
                              student: { name: student.name, nextBim: "4º Bimestre" }
                            })}
                          >
                            -
                          </span>
                        ...
                        <td className="actions-cell">
                          <button
                            ...
                            onClick={() => openModal("addObservation", {
                              student: { name: student.name }
                            })}
                          >
                            <img src={EmojiIcon} alt="Observação" width={18} height={18} />
                          </button>
                        </td>
                      </tr>
                    ))}
